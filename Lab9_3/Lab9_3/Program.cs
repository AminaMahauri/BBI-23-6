...
public class Team
{
    ...
    public Team() { }
    public int bestteam { get { return _bestteam; } set { _bestteam = value ; } }
...
class Program
{
    static void Main()
    {
        ...
        for (int i = 0; i < serializers.Length; i++)
        {
            ...
            Console.WriteLine($"Победитель - {team[0].Name} {team[0].count}");
        }
        #endregion
    }
}